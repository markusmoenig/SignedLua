...
func extractFloat4Value(_ options: [String:Any], container: VariableContainer, error: inout CompileError, name: String = "float4", isOptional: Bool = false,  ignoreErrors: Bool = false) -> Float4?
{
...
func extractFloat3Value(_ options: [String:Any], container: VariableContainer, error: inout CompileError, name: String = "float3", isOptional: Bool = false, ignoreErrors: Bool = false) -> Float3?
{
    if let value = options[name] as? String {
...
func extractFloat2Value(_ options: [String:Any], container: VariableContainer, error: inout CompileError, name: String = "float2", isOptional: Bool = false, ignoreErrors: Bool = false) -> Float2?
{
    if let value = options[name] as? String {
...
func extractFloat1Value(_ options: [String:Any], container: VariableContainer, error: inout CompileError, name: String = "float", isOptional: Bool = false, ignoreErrors: Bool = false) -> Float1?
{
...
func extractBool1Value(_ options: [String:Any], container: VariableContainer, error: inout CompileError, name: String = "bool", isOptional: Bool = false,  ignoreErrors: Bool = false) -> Bool1?
{
    if var value = options[name] as? String {
        value = value.trimmingCharacters(in: .whitespaces)
