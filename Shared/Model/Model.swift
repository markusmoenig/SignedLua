...
class Model: NSObject, ObservableObject {
    ...
    func createShapes() {
        shapes = [
            ...
            SignedCommand("Cylinder", role: .GeometryAndMaterial, action: .Add, primitive: .Cylinder, data: ["Geometry": SignedData([SignedDataEntity("height", Float(0.015), float2(0, 5)), SignedDataEntity("radius", Float(0.02), float2(0, 5)), SignedDataEntity("rounding", Float(0), float2(0, 1))])], material: SignedMaterial(albedo: float3(0.5,0.5,0.5))),
        ]
